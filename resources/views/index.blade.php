										...
										<div class="header-nav-main header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-effect-2 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													...
													<li class="dropdown">
														<a class="dropdown-item" href="demo-law-firm-news.html">
															News
														</a>
													</li>
													<li class="dropdown">
		...
		<div class="owl-carousel owl-carousel-light owl-carousel-light-init-fadeIn owl-theme manual dots-inside dots-modern dots-modern-lg dots-horizontal-center show-dots-hover show-dots-xs nav-style-1 nav-inside nav-inside-plus nav-dark nav-lg nav-font-size-lg show-nav-hover mb-0" data-plugin-options="{'autoplayTimeout': 7000}" data-dynamic-height="['700px','700px','700px','550px','500px']" style="height: 700px;">
			<div class="owl-stage-outer">
				<div class="owl-stage">
					...
					<!-- Carousel Slide 1 -->
					<div class="owl-item position-relative" style="background-image: url(img/demos/law-firm/slides/slide-1-bg.jpg); background-size: cover; background-position: center;">
						<div class="container h-100">
							<div class="row h-100">
								<div class="col-lg-6">
									<div class="d-flex flex-column justify-content-center h-100">
										<p class="custom-font-slider-2 text-dark" data-plugin-animated-letters data-plugin-options="{'startDelay': 750, 'minWindowWidth': 0, 'animationSpeed': 30}">SERVING LOS ANGELES / CALIFORNIA</p>
										<h2 class="custom-font-slider-1 mb-0 font-weight-bold appear-animation" data-appear-animation="blurIn" data-appear-animation-delay="500" data-plugin-options="{'minWindowWidth': 0}">Porto Law Firm</h2>
							...
							<div class="position-absolute left-100pct bottom-0 transform3dx-n50 w-75 ms-5">
								<img src="img/demos/law-firm/slides/slide-1-1.png" class="img-fluid mw-100 w-auto appear-animation" alt="" data-appear-animation="fadeIn" data-appear-animation-delay="100" />
							</div>
						</div>
					</div>
						...
						<div class="container h-100">
							<div class="row h-100">
								<div class="col text-center">
									<div class="d-flex flex-column justify-content-center h-100">
										<p class="custom-font-slider-2 text-light" data-plugin-animated-letters data-plugin-options="{'startDelay': 750, 'minWindowWidth': 0, 'animationSpeed': 30}">PORTO LAW FIRM IN LOS ANGELES</p>
										<h2 class="custom-font-slider-1 mb-0 font-weight-bold text-light appear-animation" data-appear-animation="blurIn" data-appear-animation-delay="500" data-plugin-options="{'minWindowWidth': 0}">Porto Law Firm</h2>
						...
						<div class="row">
							<div class="col-md-6 p-relative">
								<a href="demo-law-firm-news-post.html" class="text-decoration-none text-light">										
									...
									<img src="img/demos/law-firm/blog/blog-thumb-1.jpg" class="img-fluid" alt="Lorem Ipsum Dolor" />
								</a>
							</div>
							<div class="col-md-6">
								...
								<h3 class="custom-font-primary mb-2">
									<a href="demo-law-firm-news-post.html" class="text-dark text-transform-none font-weight-bold text-1 line-height-3 text-color-hover-primary text-decoration-none">
										Lorem ipsum dolor sit amet, consectetur</h3>
									</a>
								</h3>
								<p class="mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit quisque rutrum pellentesqu...</p>
								<a href="demo-law-firm-news-post.html" class="custom-view-more d-inline-flex font-weight-medium text-color-primary">
									View More
						...
						<div class="row">
							<div class="col-md-6 p-relative">
								<a href="demo-law-firm-news-post.html" class="text-decoration-none text-light">										
									...
									<img src="img/demos/law-firm/blog/blog-thumb-2.jpg" class="img-fluid" alt="Lorem Ipsum Dolor" />
								</a>
							</div>
							<div class="col-md-6">
								<span class="d-block text-color-grey font-weight-semibold positive-ls-2 text-2">BY ADMIN</span>
						...
						<div class="col">
							<div class="feature-box feature-box-style-2 align-items-center">
								...
								<div class="feature-box-info ps-1">
									...
									<strong class="custom-footer-strong-1"><a href="mailto:mail@example.com" class="text-color-light">MAIL@EXAMPLE.COM</a></strong>
								</div>
							</div>
						</div>
					</div>
